...
app.use(passport.initialize());//root requestがコールされたらpassport.jsを初期化
...
{
    var hashVerify1 = crypto.pbkdf2Sync(password,salt,10000,60,'sha512');
    var hashVerify = hashVerify1.toString('hex');
...
function genPassword(password)
{
    ...
    console.log(salt);
    var genhash1=crypto.pbkdf2Sync(password,salt,10000,60,'sha512');
    console.log(genhash1);
    var genhash = genhash1.toString('hex');
